...
import numpy as np
class detector():
	def __init__(self,json_fn = None,detector = None,distance = None,wavelength= None,shape = None,centeri=None,dqi = None,centerj=None,dqj = None):
	...
	def init_from_json(self,json_fn):
		...
		self.detector = self.js_data['poni']['detector']
